...
namespace Cursos.Controllers
{
    ...
    public class EstudiantesController:ControllerBase
    {
        ...
        [HttpGet("{estudiante}/matriculas/cursos")]
        public async Task<IActionResult> MatriculasEstudiante(int estudiante)
        {
            List<MatriculasEstudiante> matriculas = await ctx.Matricula
                                                    .Include(x=>x.Periodo)
                                                    .Include("InscripcionCurso.Curso")
                                                    .Where(x=>x.IdEstudiante == estudiante)
